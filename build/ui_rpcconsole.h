...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QStringLiteral("background-image: url(:/images/bkg2);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "666 - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "666 Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the 666 debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the 666-Qt help message to get a list with possible 666 command-line options.", 0));
#endif // QT_NO_TOOLTIP
