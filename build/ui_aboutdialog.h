...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About 666", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>666</b> version", 0));
...
"Copyright \302\251 2017 The 666 developers", 0));
